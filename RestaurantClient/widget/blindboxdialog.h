...
#include <QDialog>
#include <functional>
class QLabel; class QPushButton; class QVariantAnimation;
...
private:
    BlindBoxCanvas *canvas; QLabel *title; QLabel *result; QPushButton *openButton;
    int remainingChances; std::function<void()> drawAction; QVariantAnimation *animation;
    void startOpening();
};
#endif
